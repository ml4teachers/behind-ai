  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8 space-y-10">
      <header className="space-y-2">
        ...
        <p className="text-lg text-muted-foreground">{t('attention.subtitle')}</p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">{t('attention.caption')}</p>
      </section>
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="more" className="border-b-0">
            ...
            <AccordionContent className="space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>{t('attention.moreP1')}</p>
              <p>{t('attention.moreP2')}</p>
              <p>{t('attention.moreP3')}</p>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
